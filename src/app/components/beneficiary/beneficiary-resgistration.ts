  ...
  template: `
    <div class="min-h-screen bg-green-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        <div>
          <h2 class="mt-6 text-center text-3xl font-extrabold text-green-900">Registro de Beneficiario</h2>
        </div>
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <textarea id="description" name="description" required rows="3"
                        ...
                        placeholder="Descripción" [(ngModel)]="description"></textarea>
            </div>
          </div>
        ...
        <div class="flex items-center justify-between mt-4">
          <a routerLink="/beneficiary-login" class="text-sm text-green-600 hover:text-green-500">
...
export class BeneficiaryRegistrationComponent {
  ...
  validateForm(): boolean {
    if (!this.firstName || !this.lastName || !this.documentNumber || !this.phone || !this.email || !this.age || !this.address || !this.description) {
