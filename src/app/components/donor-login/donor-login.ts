  ...
  template: `
    <div class="min-h-screen bg-green-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        <div>
          <h2 class="mt-6 text-center text-3xl font-extrabold text-green-900">Iniciar sesión como Donante</h2>
        </div>
        ...
        <div class="text-center">
          <a routerLink="/donor-registration" class="font-medium text-green-600 hover:text-green-500">
